...
get_filename_component(_filename "/home/jomiseon/new_ws/src/delivery_service_robot/delivery_topics/srv/MenuSelector.srv" NAME_WE)
add_custom_target(_delivery_topics_generate_messages_check_deps_${_filename}
  COMMAND ${CATKIN_ENV} ${PYTHON_EXECUTABLE} ${GENMSG_CHECK_DEPS_SCRIPT} "delivery_topics" "/home/jomiseon/new_ws/src/delivery_service_robot/delivery_topics/srv/MenuSelector.srv" ""
)
...
_generate_srv_cpp(delivery_topics
  "/home/jomiseon/new_ws/src/delivery_service_robot/delivery_topics/srv/MenuSelector.srv"
  "${MSG_I_FLAGS}"
  ""
...
if(genpy_INSTALL_DIR AND EXISTS ${CATKIN_DEVEL_PREFIX}/${genpy_INSTALL_DIR}/delivery_topics)
  install(CODE "execute_process(COMMAND \"/usr/bin/python3\" -m compileall \"${CATKIN_DEVEL_PREFIX}/${genpy_INSTALL_DIR}/delivery_topics\")")
  # install generated code
  install(
